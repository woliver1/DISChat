...
public String toString() {
    return this.getSite() + ":" + this.getApplication() + ":" + this.getEntity();
}

//@Override
public boolean equals(EntityID eid) {
       return (eid.getSite() == this.getSite()) &&
               (eid.getApplication() == this.getApplication()) &&
               (eid.getEntity() == this.getEntity());
